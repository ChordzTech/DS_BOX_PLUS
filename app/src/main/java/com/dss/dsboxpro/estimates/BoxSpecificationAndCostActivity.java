package com.dss.dsboxpro.estimates;
...
import com.dss.dsboxpro.data.CreateEstimateDataHolder;
...
import com.dss.dsboxpro.data.repo.response.ClientDetails;
import com.dss.dsboxpro.data.repo.response.DataItem;
import com.dss.dsboxpro.databinding.ActivityBoxSpecificationAndCostBinding;
import com.dss.dsboxpro.home.HomeActivity;
import com.dss.dsboxpro.viewmodels.AppViewModelFactory;
import com.dss.dsboxpro.viewmodels.estimatesviewmodels.BoxSpecificationAndCostActivityViewModel;
import com.example.mvvmretrofit.data.repo.MainRepository;
import com.example.mvvmretrofit.data.repo.remote.RetrofitService;
import com.google.gson.Gson;

public class BoxSpecificationAndCostActivity extends BaseActivity {
    private final double wasteFromTiet = 0;
    ...
    private void updateUI() {
        activityBoxSpecificationAndCostBinding.tvTotalGsm.setText(String.valueOf(dataItem.getTotalgsm()));
        activityBoxSpecificationAndCostBinding.tvTotalBs.setText(String.valueOf(dataItem.getTotalbs()));
        activityBoxSpecificationAndCostBinding.tvTotalWeight.setText(String.valueOf(dataItem.getTotalweight()));
        activityBoxSpecificationAndCostBinding.tvNetPaperCost.setText(String.valueOf(dataItem.getNetpapercost()));
        activityBoxSpecificationAndCostBinding.tietWaste.setText(String.valueOf(dataItem.getWaste()));
//        activityBoxSpecificationAndCostBinding.tvWasteCost.setText(String.valueOf(dataItem.));
//        activityBoxSpecificationAndCostBinding.tvgrossPaperCost.setText(dataItem.);
        ...
        activityBoxSpecificationAndCostBinding.tvBoxMFGCost.setText(String.valueOf(dataItem.getBoxcost()));
        activityBoxSpecificationAndCostBinding.tvBoxPrice.setText(String.valueOf(dataItem.getBoxprice()));
        ...
        activityBoxSpecificationAndCostBinding.tvBoxPriceWithTax.setText(String.valueOf(dataItem.getBoxpricewithtax()));

        CreateEstimateDataHolder.INSTANCE.setTotalGsm(dataItem.getTotalgsm());
...
//        CreateEstimateDataHolder.INSTANCE.setCuttingFor2PlyKg(Float.parseFloat(String.valueOf(cutting)));
    ...
    private void callCreateOrUpdateEstimateAPI() {
        viewModel.createOrUpdateEstimate(isUpdate, dataItem, selectedClient, CreateEstimateDataHolder.INSTANCE.getBoxName(), (float) CreateEstimateDataHolder.INSTANCE.getLengthMm(), (float) CreateEstimateDataHolder.INSTANCE.getWidthMm(), (float) CreateEstimateDataHolder.INSTANCE.getHeightMm(), CreateEstimateDataHolder.INSTANCE.getNoOfPly(), CreateEstimateDataHolder.INSTANCE.getNoOfBox(), CreateEstimateDataHolder.INSTANCE.getCuttingLength(), CreateEstimateDataHolder.INSTANCE.getDecalSize(), CreateEstimateDataHolder.INSTANCE.getCuttingMarginMm(), CreateEstimateDataHolder.INSTANCE.getDecalMarginMm(),
                ...
                CreateEstimateDataHolder.INSTANCE.getF1Bf(), CreateEstimateDataHolder.INSTANCE.getF1Gsm(), CreateEstimateDataHolder.INSTANCE.getF1RateKg(), CreateEstimateDataHolder.INSTANCE.getF1ff(),

                CreateEstimateDataHolder.INSTANCE.getM1bf(), CreateEstimateDataHolder.INSTANCE.getM1Gsm(), CreateEstimateDataHolder.INSTANCE.getM1RateKg(),

                CreateEstimateDataHolder.INSTANCE.getF2Bf(), CreateEstimateDataHolder.INSTANCE.getF2Gsm(), CreateEstimateDataHolder.INSTANCE.getF2RateKg(), CreateEstimateDataHolder.INSTANCE.getF2ff(),

                CreateEstimateDataHolder.INSTANCE.getM2bf(), CreateEstimateDataHolder.INSTANCE.getM2Gsm(), CreateEstimateDataHolder.INSTANCE.getM2RateKg(),

                CreateEstimateDataHolder.INSTANCE.getF3Bf(), CreateEstimateDataHolder.INSTANCE.getF3Gsm(), CreateEstimateDataHolder.INSTANCE.getF3RateKg(), CreateEstimateDataHolder.INSTANCE.getF3ff(),

                CreateEstimateDataHolder.INSTANCE.getBottomBF(), CreateEstimateDataHolder.INSTANCE.getBottomGsm(), CreateEstimateDataHolder.INSTANCE.getBottomRateKg(),

                CreateEstimateDataHolder.INSTANCE.getTotalGsm(), CreateEstimateDataHolder.INSTANCE.getTotalBs(), CreateEstimateDataHolder.INSTANCE.getTotalWeight(),
                (float) CreateEstimateDataHolder.INSTANCE.getNetPaperCost(),
                (float) CreateEstimateDataHolder.INSTANCE.getTotalPaperCost(),

                (float) CreateEstimateDataHolder.INSTANCE.getBoxMfg(), (float) CreateEstimateDataHolder.INSTANCE.getBoxPrice(), CreateEstimateDataHolder.INSTANCE.getBoxPriceTax(),
...
//        CreateEstimateDataHolder.INSTANCE.getCuttingFor2PlyKg();
    ...
    private void formulaForTwoPlyKg(String bfInTopPaper, String gsmInTop, String rateKgInTop,
                                    String bfInFlutePaper, String gsmInFlutePaper,
                                    String rateKgInFlutePaper, String ffInFluteOnePaper,
                                    String decalM, String cuttingL, String waste,
                                    String convCostKg, String profit, String tax, String overhead, String noOfBox) {
        //TotalBS Formula
...
//        //Box Price with Tax
    ...
    private void formulaForSevenPly(String bfInTopPaper, String gsmInTop, String rateKgInTop, String bfInFlutePaper, String gsmInFlutePaper, String rateKgInFlutePaper, String ffInFluteOnePaper, String bfInMiddleOnePaper, String gsmInMiddleOnePaper, String rateKgInMiddleOnePaper, String bfInFluteTwoPaper, String gsmInFluteTwoPaper, String rateKgInFluteTwoPaper, String ffInFluteTwoPaper, String bfInMiddleTwoPaper, String gsmInMiddleTwoPaper, String rateKgInMiddleTwoPaper, String bfInFluteThreePaper, String gsmInFluteThreePaper, String rateKgInFluteThreePaper, String ffInFluteThreePaper, String bfInBottomPaper, String gsmInBottomPaper, String rateKgInBottomPaper, String decalM, String cuttingL, String waste, String convCostKg, String profit, String tax, String overhead, String noOfBox) {
        ...
        double gsmOfFlute = Double.parseDouble(gsmInFlutePaper);
        double valTwo = (bfOfFlute * gsmOfFlute * 0.5) / divide;
        ...
        double valFour = (bfOfFluteTwo * gsmOfFluteTwo * 0.5) / divide;
        ...
        double valFive = (bfOfMiddleTwo * gsmOfMiddleTwo * 1) / divide;
        ...
        double valSix = (bfOfFluteThree * gsmOfFluteThree * 0.5) / divide;
        //Value for Bottom
        ...
        //Total
        double total = (valueFirstOFTotalWeightThreeDigits + valueSecondOFTotalWeightThreeDigits + valueThirdOFTotalWeightThreeDigits + valueFourthOFTotalWeightThreeDigits + valueFifthOFTotalWeightThreeDigits + valueSixthOFTotalWeightThreeDigits + valueSeventhOFTotalWeightThreeDigits);
...
//        //Box Price with Tax
    ...
    private void formulaForFivePly(String bfInTopPaper, String gsmInTop, String rateKgInTop, String bfInFlutePaper, String gsmInFlutePaper, String rateKgInFlutePaper, String ffInFluteOnePaper, String bfInMiddleOnePaper, String gsmInMiddleOnePaper, String rateKgInMiddleOnePaper, String bfInFluteTwoPaper, String gsmInFluteTwoPaper, String rateKgInFluteTwoPaper, String ffInFluteTwoPaper, String bfInBottomPaper, String gsmInBottomPaper, String rateKgInBottomPaper, String decalM, String cuttingL, String waste, String convCostKg, String profit, String tax, String overhead, String noOfBox) {
        ...
        //Total
        double total = (valueFirstOFTotalWeightThreeDigits + valueSecondOFTotalWeightThreeDigits + valueThirdOFTotalWeightThreeDigits + valueFourthOFTotalWeightThreeDigits + valueFifthOFTotalWeightThreeDigits);
        double totalThreeDigits = Double.valueOf(String.format("%.3f", total));
        //Waste value
        double wasteFromTiet = Double.parseDouble(waste);
        double wastePercentage = ((totalThreeDigits * wasteFromTiet) / 100);
...
//        //Box Price with Tax
    ...
    private void formulaForOnePly(String bfInTopPaper, String gsmInTop, String rateKgInTop, String decalM, String cuttingL, String waste, String convCostKg, String profit, String tax, String overhead, String noOfBox) {
        ...
        double resultOfNPCThreeDigits = Double.valueOf(String.format("%.2f", netPaperCost));
        activityBoxSpecificationAndCostBinding.tvNetPaperCost.setText(String.valueOf(resultOfNPCThreeDigits));
