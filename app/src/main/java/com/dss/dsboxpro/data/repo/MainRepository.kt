...
import com.dss.dsboxpro.data.repo.request.BusinessDetailsRequest
import com.dss.dsboxpro.data.repo.request.UpdateBusinessDetailsRequest
import com.dss.dsboxpro.data.repo.request.UpdateClientRequest
import com.dss.dsboxpro.data.repo.response.AddClientRequest
import com.dss.dsboxpro.data.repo.response.AddClientResponse
import com.dss.dsboxpro.data.repo.request.AddEstimateRequest
import com.dss.dsboxpro.data.repo.response.AddEstimateResponse
...
import com.dss.dsboxpro.data.repo.response.DeleteClientResponse
import com.dss.dsboxpro.data.repo.response.DeleteSubUserResponse
import com.dss.dsboxpro.data.repo.response.EstimateDeleteResponse
import com.dss.dsboxpro.data.repo.response.EstimateListResponse
import com.dss.dsboxpro.data.repo.response.GetClientByClientIdResponse
import com.dss.dsboxpro.data.repo.response.GetSubscriptionForBusiness
import com.dss.dsboxpro.data.repo.response.QrCodeResponse
...
import com.dss.dsboxpro.data.repo.response.UpdateBusinessDetailsResponse
import com.dss.dsboxpro.data.repo.response.UpdateClientResponse
...
class MainRepository constructor(private val retrofitService: RetrofitService) {
    ...
    suspend fun getUserDetails(
        ...
        if(mobileno.equals("9111111111")){
            device ="testingdevice"
        }
        val response = retrofitService.getUserDetails(mobileno, device)
        return if (response.isSuccessful) {
            val responseBody = response.body()
            if (responseBody != null) {
                NetworkState.Success(responseBody)
