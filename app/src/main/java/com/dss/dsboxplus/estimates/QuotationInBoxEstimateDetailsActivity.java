...
public class QuotationInBoxEstimateDetailsActivity extends AppCompatActivity {
    ...
    private void createDsPdf() throws FileNotFoundException {
        ...
        table.addCell(new Cell().add(new Paragraph("Pankaj Kashid").setTextAlignment(TextAlignment.CENTER)).setFontSize(20f).setBold().setBorder(Border.NO_BORDER));
        table.addCell(new Cell().add(new Paragraph()).setBorder(Border.NO_BORDER));
...
//        table.addCell(new Cell().add(new Paragraph("\n")).setBorder(Border.NO_BORDER));
        ...
        document.add(new Paragraph("\n\n"));
        document.add(new Paragraph("Auto generated copy,no signature requried").setHorizontalAlignment(HorizontalAlignment.CENTER).setFontSize(10f));
        document.add(image3);
        document.close();
